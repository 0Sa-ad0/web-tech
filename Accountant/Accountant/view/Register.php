...
<html>
<head>
	<title>Accountant Sign Up</title>
	<meta charset="utf-8">
		...
		<div class="main-content">
			...
			<div class="l-part">
				<form name="signupForm" onsubmit="return validateForm()" action="" method="POST" >
					...
					<div class="input-group">
						<span class="input-group-addon"></span>
						<input type="text" class="form-control" placeholder="Accountant IP Address" name="IP_Add">
					</div>
					...
					<?php include("../controller/insert_accountant.php"); ?>
				</form><br><br>
				<form action="Accountant_Login.php" method="post">
